...
- **STEP 2 (all three of us participate):** Manually code the yielded stems, n-grams, and skip-grams, using the codebook in Fowler et al., p. 18.
  - calculate intercoder reliability
- **STEP 3 (robustness):** rerun above analyses with `dem_liking_cses` and `rep_liking_cses` to see if how the DV is measured changes our result.
